    ...
    implements Serializable, ToString
{
     ...
     * 
     */
    public Education(final CreatedDate createdDate, final LastModifiedDate lastModifiedDate, final SourceType source, final BigInteger putCode, final Visibility visibility, final String displayIndex, final String path, final String departmentName, final String roleTitle, final FuzzyDate startDate, final FuzzyDate endDate, final Organization organization) {
