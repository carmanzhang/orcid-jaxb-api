...
@XmlType(name = "peer-reviews", propOrder = {
    "lastModifiedDate",
    "group"
})
@XmlSeeAlso({
...
public class PeerReviewsType implements Serializable, ToString
{
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2020-04-16T06:01:23+02:00", comments = "JAXB RI v2.2.11")
    protected List<PeerReviewGroup> group;
     ...
     * 
     */
    public PeerReviewsType(final LastModifiedDate lastModifiedDate, final List<PeerReviewGroup> group, final String path) {
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2020-04-16T06:01:23+02:00", comments = "JAXB RI v2.2.11")
    public List<PeerReviewGroup> getGroup() {
        if (group == null) {
            group = new ArrayList<PeerReviewGroup>();
        }
        return this.group;
    }
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2020-04-16T06:01:23+02:00", comments = "JAXB RI v2.2.11")
    public void setGroup(List<PeerReviewGroup> value) {
        this.group = null;
        if (value!= null) {
            List<PeerReviewGroup> draftl = this.getGroup();
            draftl.addAll(value);
        }
    }
