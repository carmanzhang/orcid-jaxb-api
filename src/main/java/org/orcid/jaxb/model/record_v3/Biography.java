    ...
    implements Serializable, ToString
{
     ...
     * 
     */
    public Biography(final CreatedDate createdDate, final LastModifiedDate lastModifiedDate, final String content, final Visibility visibility, final String path) {
        super(createdDate, lastModifiedDate, content, visibility, path);
    }
