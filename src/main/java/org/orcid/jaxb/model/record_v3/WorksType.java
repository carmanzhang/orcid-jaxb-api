...
public class WorksType implements Serializable, ToString
{
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2020-04-16T06:01:23+02:00", comments = "JAXB RI v2.2.11")
    protected List<WorkGroup> group;
     ...
     * 
     */
    public WorksType(final LastModifiedDate lastModifiedDate, final List<WorkGroup> group, final String path) {
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2020-04-16T06:01:23+02:00", comments = "JAXB RI v2.2.11")
    public void setGroup(List<WorkGroup> value) {
        this.group = null;
        if (value!= null) {
            List<WorkGroup> draftl = this.getGroup();
            draftl.addAll(value);
        }
    }
