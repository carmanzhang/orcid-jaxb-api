    ...
    implements Serializable, ToString
{
     ...
     * 
     */
    public Name(final CreatedDate createdDate, final LastModifiedDate lastModifiedDate, final NameType.GivenNames givenNames, final NameType.FamilyName familyName, final NameType.CreditName creditName, final Visibility visibility, final String path) {
        super(createdDate, lastModifiedDate, givenNames, familyName, creditName, visibility, path);
    }
