...
public class ServicesType implements Serializable, ToString
{
     ...
     * 
     */
    public ServicesType(final LastModifiedDate lastModifiedDate, final List<AffiliationGroup> affiliationGroup, final String path) {
