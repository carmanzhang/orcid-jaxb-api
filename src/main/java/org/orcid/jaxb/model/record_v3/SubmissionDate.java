...
/**
 * The date time when the ORCID record was first created.
 * 			
 * 
...
public class SubmissionDate implements Serializable, ToString
{
     ...
     * 
     */
    public SubmissionDate(final XMLGregorianCalendar value) {
        this.value = value;
    }
