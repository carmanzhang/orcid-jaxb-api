...
public class WorkTitle implements Serializable, ToString
{
     ...
     * 
     */
    public WorkTitle(final String title, final String subtitle, final TranslatedTitle translatedTitle) {
        this.title = title;
