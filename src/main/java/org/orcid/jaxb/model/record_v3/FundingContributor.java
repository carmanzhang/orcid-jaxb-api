...
public class FundingContributor implements Serializable, ToString
{
     ...
     * 
     */
    public FundingContributor(final OrcidId contributorOrcid, final CreditName creditName, final ContributorEmail contributorEmail, final FundingContributorAttributes contributorAttributes) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            FundingContributorAttributes theContributorAttributes;
