...
public class FundingsType implements Serializable, ToString
{
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2020-04-16T06:01:23+02:00", comments = "JAXB RI v2.2.11")
    protected List<FundingGroup> group;
     ...
     * 
     */
    public FundingsType(final LastModifiedDate lastModifiedDate, final List<FundingGroup> group, final String path) {
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2020-04-16T06:01:23+02:00", comments = "JAXB RI v2.2.11")
    public List<FundingGroup> getGroup() {
        if (group == null) {
            group = new ArrayList<FundingGroup>();
        }
        return this.group;
    }
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2020-04-16T06:01:23+02:00", comments = "JAXB RI v2.2.11")
    public void setGroup(List<FundingGroup> value) {
        this.group = null;
        if (value!= null) {
            List<FundingGroup> draftl = this.getGroup();
            draftl.addAll(value);
        }
    }
