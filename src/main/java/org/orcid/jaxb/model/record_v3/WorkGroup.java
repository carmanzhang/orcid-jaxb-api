...
public class WorkGroup implements Serializable, ToString
{
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2020-04-16T06:01:23+02:00", comments = "JAXB RI v2.2.11")
    protected List<WorkSummary> workSummary;
     ...
     * 
     */
    public WorkGroup(final LastModifiedDate lastModifiedDate, final ExternalIds externalIds, final List<WorkSummary> workSummary) {
     ...
     * This is why there is not a <CODE>set</CODE> method for the workSummary property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWorkSummary().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2020-04-16T06:01:23+02:00", comments = "JAXB RI v2.2.11")
    public void setWorkSummary(List<WorkSummary> value) {
        this.workSummary = null;
        if (value!= null) {
            List<WorkSummary> draftl = this.getWorkSummary();
            draftl.addAll(value);
        }
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<WorkSummary> theWorkSummary;
            theWorkSummary = (((this.workSummary!= null)&&(!this.workSummary.isEmpty()))?this.getWorkSummary():null);
            strategy.appendField(locator, this, "workSummary", buffer, theWorkSummary);
        }
        return buffer;
    }
